...
public class VelocityRendererImplTest {
    ...
    public void testGenerateContentByFileResource() {
        ...
        String resource = Constraints.SYSTEM_USER_HOME_DIR;
        if (properties != null) {
            properties.clear();
        }
        properties.put("property_key", "value");
        ...
        //plain template
        String result_00
                = instance.generateContentByFileResource(resource, "/template.vm", properties);
        String result_01
                = instance.generateContentByFileResource(resource, "/template.vm", null);
        //with properties
        String result_02
                = instance.generateContentByFileResource(resource, "/template_1.vm", properties);
        String result_03
                = instance.generateContentByFileResource(resource, "/template_1.vm", null);
